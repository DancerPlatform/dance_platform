...
export default function ClientSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (user) {
      // Redirect to client login or dashboard
      router.push('/login/client?signup=success')
    }
  }
    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      ...
      <Card className="w-full max-w-md bg-black/80 px-4 py-20 border-white/20">
        <CardHeader className="text-center text-white space-y-2">
          ...
          <CardTitle className="text-3xl">Client Sign Up</CardTitle>
          <CardDescription className="text-gray-400">
            Create your client account to hire dancers
          </CardDescription>
        </CardHeader>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-white/10 border-white/20 text-white placeholder:text-gray-500"
              />
              <p className="text-xs text-gray-400">Leave blank if you don&apos;t have a company ID</p>
            </div>
          ...
          <div className="mt-4 text-center">
            <a href="/login/client" className="text-sm text-gray-400 hover:text-white transition-colors">
