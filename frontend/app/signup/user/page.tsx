...
export default function UserSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (user) {
      // Redirect to user login or home page
      router.push('/login/user?signup=success')
    }
  }
    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      ...
      <Card className="w-full max-w-md bg-black/80 px-4 py-20 border-white/20">
        <CardHeader className="text-center text-white space-y-2">
          ...
          <CardTitle className="text-3xl">User Sign Up</CardTitle>
        ...
        <CardContent>
          ...
          <div className="mt-4 text-center">
            <a href="/login/user" className="text-sm text-gray-400 hover:text-white transition-colors">
